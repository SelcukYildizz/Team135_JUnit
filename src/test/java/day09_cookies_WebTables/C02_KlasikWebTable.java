...
public class C02_KlasikWebTable extends TestBase_BeforeAfter {
    ...
    public void test01() {
        ...
        //int actualSutunSayisi =

        List<WebElement> birinciSatirElementleriList = driver
        ...
        List<WebElement> ucuncuSutunElementleriList = driver
                .findElements(By.xpath("//tbody/tr/td[3]"));
        ...
        System.out.println(getData(5,4));
    ...
    public String getData (int satir, int sutun){
        ...
        WebElement isteneneDataElementi = driver.findElement(By.xpath(dinamikXpath));
        return isteneneDataElementi.getText();
