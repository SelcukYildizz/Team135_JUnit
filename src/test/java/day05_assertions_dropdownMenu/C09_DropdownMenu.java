...
public class C09_DropdownMenu extends TestBase_BeforeAfter {
    ...
    public void zeroTest(){
        ...
        WebElement signInButonu = driver.findElement(By.className("icon-signin"));
        signInButonu.click();
        ...
        WebElement currencyDD = driver.findElement(By.id("pc_currency"));
        Select select = new Select(currencyDD);
